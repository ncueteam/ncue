...
class FlutterBlueApp extends RouteView {
  const FlutterBlueApp({Key? key})
      : super(key, routeIcon: Icons.bluetooth, routeName: "/bluetooth-app");

  @override
  State<StatefulWidget> createState() => _FlutterBlueApp();
}

class _FlutterBlueApp extends State<FlutterBlueApp> {
  @override
